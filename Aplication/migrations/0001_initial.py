    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='Documento')),
                ('password', models.CharField(max_length=256, verbose_name='Password')),
                ('phone', models.CharField(max_length=20, verbose_name='phone')),
                ('city', models.CharField(max_length=20, verbose_name='city')),
                ('mail', models.CharField(max_length=45, verbose_name='email')),
        ...
        migrations.CreateModel(
            name='Medicos',
            fields=[
                ('id_medico', models.BigAutoField(primary_key=True, serialize=False, verbose_name='id_medico')),
        ...
        migrations.CreateModel(
            name='Horarios',
            fields=[
                ('id_horario', models.BigAutoField(primary_key=True, serialize=False, verbose_name='id_horario')),
